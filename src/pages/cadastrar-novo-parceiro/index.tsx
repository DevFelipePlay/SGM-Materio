...
import RegisterMultiStepsWizard from '../../components/RegisterMultiSteps'
...
CadastrarNovoParceiro.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>

CadastrarNovoParceiro.guestGuard = true

export default CadastrarNovoParceiro
