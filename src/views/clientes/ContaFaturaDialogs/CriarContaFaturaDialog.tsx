...
const CriarContaFaturaDialog = (props: Props) => {
  // ** Props
  ...
  return (
    <Dialog fullWidth open={open} onClose={handleClose} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 900 } }}>
      <DialogTitle display='flex' justifyContent='center' alignItems='center' gap={3}>
        <Typography variant='h5'>Criar Conta Fatura</Typography>
      </DialogTitle>
      ...
      >
        <CustomDataGrid columns={columns} rows={rows} checkboxSelection titleButton='Criar Nova Conta Fatura' />
      </DialogContent>
    </Dialog>
  )
}

export default CriarContaFaturaDialog
